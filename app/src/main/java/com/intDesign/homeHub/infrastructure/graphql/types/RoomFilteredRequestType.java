...
public final class RoomFilteredRequestType implements InputType {
    ...
    RoomFilteredRequestType(Input<String> searchTerm, Input<List<String>> ids) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof RoomFilteredRequestType) {
            RoomFilteredRequestType that = (RoomFilteredRequestType) o;
    ...
    public static final class Builder {
        ...
        public RoomFilteredRequestType build() {
            return new RoomFilteredRequestType(searchTerm, ids);
        }
    }
}
