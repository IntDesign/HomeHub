...
public final class MaterialExpenditureFilterRequestType implements InputType {
    ...
    MaterialExpenditureFilterRequestType(Input<String> searchTerm, Input<List<String>> ids) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof MaterialExpenditureFilterRequestType) {
            MaterialExpenditureFilterRequestType that = (MaterialExpenditureFilterRequestType) o;
    ...
    public static final class Builder {
        ...
        public MaterialExpenditureFilterRequestType build() {
            return new MaterialExpenditureFilterRequestType(searchTerm, ids);
        }
    }
}
