...
public final class RoomWallObjectFilteredRequestType implements InputType {
    ...
    RoomWallObjectFilteredRequestType(Input<String> searchTerm, Input<List<String>> ids) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof RoomWallObjectFilteredRequestType) {
            RoomWallObjectFilteredRequestType that = (RoomWallObjectFilteredRequestType) o;
    ...
    public static final class Builder {
        ...
        public RoomWallObjectFilteredRequestType build() {
            return new RoomWallObjectFilteredRequestType(searchTerm, ids);
        }
    }
}
