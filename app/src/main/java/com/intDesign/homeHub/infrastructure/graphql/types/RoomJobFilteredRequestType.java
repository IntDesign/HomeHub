...
public final class RoomJobFilteredRequestType implements InputType {
    ...
    RoomJobFilteredRequestType(Input<String> searchTerm, Input<List<String>> ids) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof RoomJobFilteredRequestType) {
            RoomJobFilteredRequestType that = (RoomJobFilteredRequestType) o;
    ...
    public static final class Builder {
        ...
        public RoomJobFilteredRequestType build() {
            return new RoomJobFilteredRequestType(searchTerm, ids);
        }
    }
}
