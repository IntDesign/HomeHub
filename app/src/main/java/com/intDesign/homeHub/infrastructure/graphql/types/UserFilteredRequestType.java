...
public final class UserFilteredRequestType implements InputType {
    ...
    UserFilteredRequestType(Input<String> searchTerm, Input<List<String>> ids,
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof UserFilteredRequestType) {
            UserFilteredRequestType that = (UserFilteredRequestType) o;
    ...
    public static final class Builder {
        ...
        public UserFilteredRequestType build() {
            return new UserFilteredRequestType(searchTerm, ids, names);
        }
    }
}
